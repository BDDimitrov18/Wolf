...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240906172347_OutsiderEmployee")]
    partial class OutsiderEmployee
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Models.PowerOfAttorneyDocument", b =>
                {
                    b.Property<int>("PowerOfAttorneyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PowerOfAttorneyId"), 1L, 1);
                    ...
                    b.HasKey("PowerOfAttorneyId");

                    b.ToTable("powerOfAttorneyDocuments");
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Models.starRequest_EmployeeRelashionship", b =>
                {
                    b.Property<int>("RequestId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("starRequest_EmployeeRelashionships");
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Models.ApplicationUser", b =>
                {
                    b.HasOne("DataAccessLayer.Models.Employee", "Employee")
                        .WithOne()
                        .HasForeignKey("DataAccessLayer.Models.ApplicationUser", "EmployeeId");
            ...
            modelBuilder.Entity("DataAccessLayer.Models.DocumentPlot_DocumentOwnerRelashionship", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Models.PowerOfAttorneyDocument", "powerOfAttorneyDocument")
                        .WithMany()
                    ...
                    b.Navigation("powerOfAttorneyDocument");
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Request", b =>
                {
                    b.HasOne("DataAccessLayer.Models.Employee", "RequestCreator")
                        .WithMany()
            ...
            modelBuilder.Entity("DataAccessLayer.Models.starRequest_EmployeeRelashionship", b =>
                {
                    b.HasOne("DataAccessLayer.Models.Employee", "Employee")
                        .WithMany("Request_EmployeeRelashionships")
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Employee", b =>
                {
                    b.Navigation("Request_EmployeeRelashionships");
                });
